...
\lettrine{A}{o} longo deste capítulo detallarase en que consiste RISC-V, a estrutura básica, o porqué é interesante e cales foron os motivos de que fose empregado como obxectivo deste proxecto.
...
\begin{table}[hp!]
  ...
  \begin{tabular}{p{5cm}|p{7cm}}
    \rowcolor{udcpink!25}
    \textbf{Nome da extensión} & \textbf{Descrición} \\\hline
    \textit{M} & Extensión estándar para multiplicación de enteiros, divisións e resto \\
    \textit{A} & Extensión estándar para operacións atómicas \\
    \textit{F} & Extensión estándar punto flotante de precisión simple \\
    \textit{D} & Extensión estándar punto flotante de precisión dobre \\
  ...
  \end{tabular}
  \caption{Nome e descricións das extensións}
